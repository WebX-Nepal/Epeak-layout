      ...
      <h3 className="text-5xl mb-8 mt-4 text-center font-Cormorant font-semibold">Our Patners</h3>
          ...
          <div className="flex justify-center gap-32 items-start mt-6  ">
            <div className="flex flex-col gap-3 justify-center">
              <h3 className="font-Cormorant text-3xl font-semibold">About Us</h3>
              <h4>Why with us?</h4>
              <h4>Who we are?</h4>
            ...
            <div className="flex flex-col gap-3">
              <h3 className="font-Cormorant text-3xl font-semibold">Trekking</h3>
            ...
            <div className="flex flex-col gap-3 ">
              <h3 className="font-Cormorant text-3xl font-semibold">Expeditions</h3>
              <h4>8000res</h4>
              <h4>7000res</h4>
              <h4>6000res</h4>
              <h4>7 Submmits</h4>
            ...
            <div className="flex flex-col gap-3">
              <h3 className="font-Cormorant text-3xl font-semibold">Epeak Expeditions</h3>
