    ...
    >
      <div className="flex flex-col mt-4 gap-2 w-[15%] ">
        <ul className="text-slate-200 ">
          <li className="border-b cursor-pointer px-5 py-1 mt-4 text-white" onClick={()=>setShowMountain("8000")}>
            8000 meters
          </li>
          <li className="border-b cursor-pointer px-5 py-1 mt-4" onClick={()=>setShowMountain("7000")}>
            7000 meters
          </li>
          <li className="border-b cursor-pointer px-5 py-1 mt-4" onClick={()=>setShowMountain("6000")}>
            6000 meters
          </li>
          <li className="border-b cursor-pointer px-5 py-1 mt-4">Other</li>
        </ul>
        {/* <span>7 Summits</span>
        <span>VIP & LUXURY SERVICE</span> */}
      </div>

      {showMountain==="8000" && <div className="w-[80%] flex flex-wrap gap-8 uppercase text-xl  font-semibold mt-4 ">
              ...
              >
                ...
                <div className="w-[65%] flex flex-col justify-center font-poppins">
                  ...
                  <p className="text-xs text-slate-600 ">
                    {mountain.height} <span className="lowercase">meters</span>{" "}
                  </p>
                </div>
              </div>
            );
      ...
      {
        showMountain ==="7000" && <div> 7000</div>
      }
      {
        showMountain ==="6000" && <div> 6000</div>
      }
    </div>
  );
}
