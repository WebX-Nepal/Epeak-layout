...
export default function Expeditions({ setShowExpeditions }) {
  return (
    <div
      ...
      className="absolute left-0 z-30 w-full bg-opacity-75 bg-[#023047]  top-20  font-poppins text-white px-32 py-8 flex"
    >
      ...
      <div className="w-[80%] flex flex-wrap gap-8 uppercase text-xl  font-semibold ">
        ...
        <div className="p-4 flex justify-center items-center rounded-md  cursor-pointer w-[280px]  h-[200px] bg-cover bg-[url('https://images.squarespace-cdn.com/content/v1/5a3bb03b4c326d76de73ddaa/1622203213079-WST8ZGC284MLBYMHHK0C/The%2BCommon%2BWanderer%2BAnnapurna%2Bcircuit%2Btrek%2BNepal-4_1.jpg')]">
          6000ers
        </div>
      </div>
    </div>
