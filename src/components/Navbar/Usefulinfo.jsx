export default function Usefulinfo({ setShowUseful }) {
  return (
    <div
      ...
      className=" p-8 text-white font-poppins flex sticky bg-opacity-75  z-10 top-16 "
    >
      <div
        className="w-[65%] bg-transparent "
        
      ></div>
      <div onMouseEnter={() => setShowUseful(true)}
      onMouseLeave={() => setShowUseful(false)} className="bg-[#023047] bg-opacity-75 w-[330px] flex flex-col p-8 gap-4">
