...
const transHimalayaList = [
    {id:1,
      title: "Around Dhaulagiri circuit trek",
      photo: annapurna,
    },
    {id:2,
...
export default function TransHimalayaTrek() {
  return (
    <>
  
    <TrekkingHero photo={annapurna} title={"Trans Himalaya Trekking"} />
      <div className="px-32 py-16 flex flex-col gap-4 text-justify">
  
      
      <div className=" ">
        <h3 className="text-2xl text-[#26ACE2]">Trans Himalaya Trekking</h3>
        <p>
      ...
      <TrekkingTrips list={transHimalayaList}/>
      <LastFooter />
    </>
  )
}
