      ...
      <div className=" h-[100vh] w-full bg-[url('https://images.unsplash.com/photo-1437382944886-45a9f73d4158?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-center bg- ">
        <div className="h-full w-full bg-black/30  flex flex-col justify-end px-40 py-28 gap-8 ">
          ...
          <p className="font-poppins text-2xl font-light lg:w-[50%]  text-slate-200">
            Mt. Everest Expedition is a lifetime mountaineering experience that
            allows you to stand on the highest point in the world.
          </p>
        </div>
      </div>
      {/* second section */}
      <div className="bg-[#444444]  h-[60vh] px-40 py-12  flex justify-center gap-20">
        ...
        <div className="flex gap-8">
          <div className="flex flex-col gap-8">
            ...
            <Icon color="#66a0d3" width={25} icon="icon-park-solid:sleep-two" />
            <Icon color="#66a0d3" width={25} icon="heroicons-solid:thumb-up" />
        ...
        <div className="w-[67%] pl-40 py-24">
          ...
          <div className="flex flex-col">
            ...
            <p className="pt-8 text-justify">
              Ask an adventurer about their dream, and they will answer you with
              a word; EVEREST. Who would not want to reach the top of the world?
              Who would not want to touch the sky? It’s the trip of a lifetime,
              the Everest Expedition. Mt. Everest is the highest mountain in the
              world and is located in the Himalayas, on the border between Nepal
              and China. Mt. Everest, also known as The Sagarmatha in Nepali is
              the tallest peak on earth with an altitude of 8848.86m. The
              southern face lies in Nepal whereas the northern face is in Tibet.
              In 1715, China surveyed the mountain for the first time while they
              were mapping Chinese territory and depicted it as Mount
              Qomolangma. British Indian government 1856 again measured Mount
              Everest during their Great Trigonometry Survey. Back then, it was
              named Peak XV and said to be 8840m tall. Peak XV was renamed after
              Sir George Everest as Mount Everest, the name given in his honor,
              who was a lead surveyor in 1856. Sir George was a Welsh Surveyor;
          ...
          <div className="mt-16">
            ...
            <Icon color="#215D91" width={30} icon="fa:gears" />
              <h4 className="uppercase whitespace-nowrap text-2xl font-Cormorant font-semibold" >gears list</h4>
              <div className="w-full">
                <hr />
              </div>
            </div>
            ...
            <div className="mt-8 h-[30vh] gap-5 grid grid-cols-2">
              <div className="flex justify-center items-center bg-[url('https://images.unsplash.com/photo-1514281427873-10a6c9733091?q=80&w=2034&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center">
                <p className="text-slate-100 text-xl font-poppins font-bold">Gear Guide Book</p>
              </div>
